...
it('defaults a minimal checkout order to the inside-area district when none is provided', function () {
...
it('defaults a minimal buy-now order to the inside-area district when none is provided', function () {
