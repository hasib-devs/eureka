        ...
        <div class="">
            <div class="row mb-2">
                ...
                @if (auth()->user()->shop_info->name == 'null_wait')
                    <div class="col-md-12">
                        <a style="background: #c00b0b;width: 100%;display: block;color: white;padding: 10px;border-radius: 10px;text-align: center;font-size: 20px;font-weight: 800;"
                            href="profile/update">Please Complete Your profile.</a>
                    </div>
                @endif
                @if (auth()->user()->is_approved == 0)
                    <p style="font-size: 24px;padding: 20px;text-align: center;margin: auto;color: red;font-family: auto;">
                        Your Account is Under Review.You Cant Upload Product At This Time</p>
                @endif
            </div>
        </div><!-- /. -->
    </section>
