                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="file" name="avatar"
                                                id="avatar"class="form-control dropify @error('avatar') is-invalid @enderror"
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="file" name="profile"
                                                id="avatar"class="form-control dropify @error('profile') is-invalid @enderror"
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="file" name="cover_photo"
                                                id="cover_photo"class="form-control dropify @error('cover_photo') is-invalid @enderror"
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="file" name="nid" id="nid" accept="image/*"
                                                class="form-control dropify @error('nid') is-invalid @enderror"
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="file" name="trade" id="trade" accept="image/*"
                                                class="form-control dropify @error('trade') is-invalid @enderror"
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" name="name"
                                                ...
                                                value="{{ $vendor->name ?? old('name') }}" placeholder="Name">
                                            @error('name')
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" name="username"
                                                ...
                                                value="{{ $vendor->username ?? old('username') }}" placeholder="Username">
                                            @error('username')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" name="phone" id="phone"
                                                class="form-control @error('phone') is-invalid @enderror" maxlength="25"
                                                value="{{ $vendor->phone ?? old('phone') }}" placeholder="Phone Number">
                                            @error('phone')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" name="Rocket" id="Rocket"
                                                ...
                                                class="form-control @error('Rocket') is-invalid @enderror"
