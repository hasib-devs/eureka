                ...
                <div class="card-body">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="name" id="name" placeholder="Write staff name"
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="username" id="username" placeholder="Write staff username"
                                class="form-control @error('username') is-invalid @enderror"
                                value="{{ $staff->username ?? old('username') }}" required>
                            @error('username')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="phone" id="phone" placeholder="write staff phone number"
                                class="form-control @error('phone') is-invalid @enderror"
                                value="{{ $staff->phone ?? old('phone') }}" required>
                            @error('phone')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
