                        ...
                        <form action="{{ route('admin.setting_g') }}" method="POST">
                            ...
                            <div class="card-body getway form-row">
                                ...
                                <div class="form-group col-md-6 col-12">
                                    <label><input type="checkbox" name="bkash"
                                ...
                                <div class="form-group col-md-6 col-12">
                                    <label><input type="checkbox" name="nagad"
                                ...
                                <div class="form-group col-md-6 col-12">
                                    <label><input type="checkbox" name="rocket"
                                ...
                                <div class="form-group col-md-6 col-12">
                                    <label><input type="checkbox" name="wallate"
                            ...
                            <div class="card-body getway form-row">
                                <div class="form-group col-md-6 col-12 bg-gray py-4 px-3">
                                    <label><input type="checkbox" name="bank"
                                ...
                                <div class="form-group col-md-6 col-12 bg-gray py-4 px-3">
                                    <label><input type="checkbox" name="cod"
                                    ...
                                    <p class="text-warning">All Charges are not related with COD, it will effect also all
                                        payment getway</p>
                                    <label for="shipping_free_above" class="text-capitalize">Shipping Charge Free Above
                                        Amount</label>
                                    <input name="shipping_free_above" id="shipping_free_above" class="form-control"
                                        type="text" value="{{ setting('shipping_free_above') ?? 10000 }}">

                                    <label for="shipping_range_inside" class="text-capitalize">Text - Shipping in
                                        Range</label>
                                    <input name="shipping_range_inside" id="shipping_range_inside" class="form-control"
                                        type="text" value="{{ setting('shipping_range_inside') ?? 'Dhaka' }}">

                                    <label for="shipping_charge" class="text-capitalize">Shipping Charge Inside
                                        Range</label>
                                    <input name="shipping_charge" id="shipping_charge" class="form-control"
                                        type="text" value="{{ setting('shipping_charge') ?? 80 }}">

                                    <label for="shipping_charge_out_of_range" class="text-capitalize">Shipping Charge Out
                                        Of Range</label>
                            ...
                            <div class="card-body row getway form-row">
                                <div class="col-sm-6" style="background:#45b03c80">
                                    ...
                                    <div class="form-group">
                                        <label>StoreID</label>
                                        <input type="" class="form-control" name="astore"
                                            value="{{ setting('astore') }}">
                                    </div>
                                    <div class="form-group">
                                        <label>Signature key</label>
                                        <input type="" class="form-control" name="akey"
                                            value="{{ setting('akey') }}">
                                    </div>
                                    <div class="form-group">
                                        <label> Mode</label>
                                    ...
                                    <div class="form-group">
                                        <label><input type="checkbox" name="aamar"
                                ...
                                <div class="col-sm-6" style="background:#80b8ea6e">
                                    ...
                                    <div class="form-group">
                                        <label>API Key</label>
                                        <input type="" class="form-control" name="uapi"
                                            value="{{ setting('uapi') }}">
                                    </div>
                                    <div class="form-group">
                                        <label>Base Url</label>
                                        <input type="" class="form-control" name="ubase"
                                            value="{{ setting('ubase') }}">
                                    </div>
                                    <div class="form-group">
                                        <label> Mode</label>
                                    ...
                                    <div class="form-group">
                                        <label><input type="checkbox" name="uddok"
