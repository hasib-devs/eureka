                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea name="description" id="description" rows="4" placeholder="write shop description"
                                class="form-control @error('description') is-invalid @enderror">{{ $vendor->shop_info->description ?? old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="file" name="profile" id="profile" accept="image/*"
                                ...
                                data-default-file="@isset($vendor) /uploads/shop/profile/{{ $vendor->shop_info->profile }}@enderror">
                            @error('profile')
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="file" name="cover_photo" id="cover_photo" accept="image/*"
                                class="form-control dropify @isset($vendor) /uploads/shop/cover/{{ $vendor->shop_info->cover_photo }}@enderror">
                        @error('cover_photo')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    </div>
                     <div class="form-group col-md-6">
                        ...
                        <input type="file" name="nid" id="nid" accept="image/*" class="form-control dropify ___inline_directive___________17___" data-default-file="@isset($vendor) /uploads/shop/nid/{{ $vendor->shop_info->nid }}@enderror">
                        @error('nid')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    </div>
                     ...
                     <div class="form-group col-md-6">
                        ...
                        <input type="file" name="trade" id="trade" accept="image/*" class="form-control dropify ___inline_directive_____________18___" data-default-file="@isset($vendor) /uploads/shop/trade/{{ $vendor->shop_info->trade }}@enderror">
                        @error('trade')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group">
                    <button class="mt-1 btn btn-primary">
                        ...
                        @else
                            ...
                            Submit
                        @endisset" data-default-file="@isset($vendor) /uploads/shop/cover/{{ $vendor->shop_info->cover_photo }}@enderror">
                        @error('cover_photo')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    </div>
