    ...
    <section class="mb-6">
        <div class="flex flex-wrap items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-3">
                <x-ui.button variant="outline" :href="routeHelper('banner')">
                    <i class="fas fa-long-arrow-alt-left text-xs"></i> Back to List
                </x-ui.button>
                <ol class="flex items-center gap-1 text-sm text-slate-400">
                    <li><a href="{{ routeHelper('dashboard') }}" class="transition-colors hover:text-primary">Home</a></li>
                    <li><i class="fas fa-chevron-right text-[9px]"></i></li>
                    <li><a href="{{ routeHelper('banner') }}" class="transition-colors hover:text-primary">Banners</a></li>
                    <li><i class="fas fa-chevron-right text-[9px]"></i></li>
                ...
                <div class="rounded-xl border border-slate-200 bg-white shadow-sm">
                    <div class="flex items-center gap-3 border-b border-slate-200 px-4 py-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-slate-500">Image, target URL and visibility</p>
                        </div>
                    </div>

                    <div class="space-y-4 p-5">
                        {{-- Banner Image (Dropify — keep raw input, JS hooks preserved) --}}
                        <div>
                            <label for="image" class="mb-1 block text-sm font-medium text-slate-700">Banner Image</label>
                        ...
                        <div>
                            <label class="inline-flex cursor-pointer items-center gap-3">
                                <input type="checkbox" class="peer sr-only" name="status" id="status" @checked($banner->status ?? true)>
                        ...
                        <div>
                            <label class="inline-flex cursor-pointer items-center gap-3">
                                <input type="checkbox" class="peer sr-only" name="is_feature" id="is_feature" @checked($banner->is_feature ?? true)>
                                <div class="peer relative h-6 w-11 rounded-full bg-slate-200 transition-colors after:absolute after:left-0.5 after:top-0.5 after:h-5 after:w-5 after:rounded-full after:border after:border-slate-300 after:bg-white after:shadow after:transition-all peer-checked:bg-primary peer-checked:after:translate-x-5 peer-checked:after:border-white peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-primary/50"></div>
