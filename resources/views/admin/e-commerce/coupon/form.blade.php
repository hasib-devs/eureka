                        ...
                        <div class="card-body">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="code" id="code" placeholder="Write coupon code"
                                        class="form-control @error('code') is-invalid @enderror"
                                        value="{{ $coupon->code ?? old('code') }}" required autocomplete="off">
                                    @error('code')
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="discount" id="discount"
                                        ...
                                        value="{{ $coupon->discount ?? old('discount') }}" required>
                                    @error('discount')
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" name="total_use_limit" id="total_use_limit"
                                        placeholder="Enter total use limit"
                                        class="form-control @error('total_use_limit') is-invalid @enderror"
                                        value="{{ $coupon->total_use_limit ?? old('total_use_limit') }}" required>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="date" name="expire_date" id="expire_date"
                                        ...
                                        value="{{ $coupon->expire_date ?? old('expire_date') }}" required>
                                    @error('expire_date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" id="description" cols="5" placeholder="Write coupon description"
                                    class="form-control @error('description') is-invalid @enderror">{{ $coupon->description ?? old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
