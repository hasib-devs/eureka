            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12 col-sm-6">
                        ...
                        <div class="col-12">
                            <img src="{{ asset('uploads/product/' . $product->image) }}" class="product-image"
                                alt="Product Image">
                        </div>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-2">
                                                                            <a class="btn btn-danger"
                                                                                href="{{ route('admin.comment', $comment->id) }}">Delete</a>
                                                                        </div>
                                                                    </div>
                                                                        ...
                                                                        <div class="media mt-4">
                                                                            ...
                                                                            <div class="media-body">
                                                                                <div class="row">
                                                                                    ...
                                                                                    <div class="col-2">
                                                                                        <a class="btn btn-danger"
                                                                                            href="{{ route('admin.comment', $reply->id) }}">Delete</a>
                                                                                    </div>
                                                                                </div>
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="side-2 col-11">
                                            <div class="d-flex">
                                                ...
                                                <a class="btn btn-danger"
                                                    href="{{ route('admin.rating', $review->id) }}">Delete</a><a
                                                    class="btn btn-warning"
                                                    href="{{ route('admin.rating.edit', $review->id) }}">Edit</a>
                                            </div>
