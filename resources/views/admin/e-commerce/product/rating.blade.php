                ...
                <div class="card">
                    ...
                    <form action="{{ route('admin.rating.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <h6 style="border: 1px solid gainsboro;padding: 5px;border-radius: 5px;"> <button
                                    style="width: 100%;text-align:left;" type="button" data-toggle="collapse"
                                    data-target="#BookOpen" aria-expanded="false" aria-controls="BookOpen">Upload More
                                    Img:<i style="float: right;top: 8px;position: relative;" class="fas fa-arrow-down"></i>
                                </button></h6>
                            <style type="text/css">
                                #BookOpen .form-group {
                                    width: 100%;
                            ...
                            <div class="form-row col-md-12 spec collapse" id="BookOpen"
                                style="background: #dcdcdc3d;border-radius: 5px;padding: 10p;">
