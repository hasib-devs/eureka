    ...
    <section class="mb-6">
        <div class="flex flex-wrap items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-3">
                <x-ui.button variant="outline" :href="routeHelper('sub-category')">
                    <i class="fas fa-long-arrow-alt-left text-xs"></i> Back to List
                </x-ui.button>
                <ol class="flex items-center gap-1 text-sm text-slate-400">
                    <li><a href="{{ routeHelper('dashboard') }}" class="transition-colors hover:text-primary">Home</a></li>
                    <li><i class="fas fa-chevron-right text-[9px]"></i></li>
                    <li><a href="{{ routeHelper('sub-category') }}" class="transition-colors hover:text-primary">Sub Categories</a></li>
                    <li><i class="fas fa-chevron-right text-[9px]"></i></li>
                ...
                <div class="rounded-xl border border-slate-200 bg-white shadow-sm">
                    <div class="flex items-center gap-3 border-b border-slate-200 px-4 py-4">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-slate-500">Parent category, name, cover photo and visibility</p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4 p-5">
                        ...
                        <div>
                            <div class="flex items-center gap-3">
                                <input type="checkbox" class="peer sr-only" name="status" id="status" @checked($subCategory->status ?? true)>
                                <label for="status"
                        ...
                        <div>
                            <div class="flex items-center gap-3">
                                <input type="checkbox" class="peer sr-only" name="is_feature" id="is_feature" @checked($subCategory->is_feature ?? false)>
