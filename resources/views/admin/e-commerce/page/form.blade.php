                ...
                <form action="{{ route('admin.page.make') }}" method="POST">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input value="{{ $page->name ?? old('name') }}" type="text" name="name" class="form-control"
                                value="">
                        </div>
                        <div class="form-group">
                            <label for="name">Title:</label>
                            <input value="{{ $page->title ?? old('title') }}" type="text" name="title" class="form-control"
                                value="">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="position" id="">
                                <option @isset($page) {{ $page->position == 0 ? 'selected' : '' }} @endisset
                                    value="0">Nav</option>
                                <option @isset($page){{ $page->position == 1 ? 'selected' : '' }} @endisset
                                    value="1">bottom</option>
                                <option @isset($page){{ $page->position == 2 ? 'selected' : '' }} @endisset
                                    value="2">Both</option>
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control" name="status" id="">
                                <option @isset($page){{ $page->status == 0 ? 'selected' : '' }} @endisset
                                    value="1">Active</option>
                                <option @isset($page) {{ $page->status == 1 ? 'selected' : '' }}  @endisset
