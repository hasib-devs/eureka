                        ...
                        <div class="card card-success">
                            ...
                            <small class="p-4 bg-light text-primary">
                                <a target="_blank" class="bg-warning p-2"
                                    href="https://getbootstrap.com/docs/4.5/components/alerts/">Help for HTML snippet from
                                    Bootstrap V5.4.3</a>
                            </small>
                                    ...
                                    <div class="border border-info py-2 mt-2">
                                        ...
                                        <div class="form-group col-md-12">
                                            <label for="BELOW_SLIDER_HTML_CODE" class="text-capitalize">Custom Html
                                                Code</label>
                                            <textarea name="BELOW_SLIDER_HTML_CODE" id="BELOW_SLIDER_HTML_CODE" rows="4" class="form-control ">{{ $BELOW_SLIDER_HTML_CODE->value }}</textarea>
                                        </div>
                                    </div>
                                    <div class="border border-info py-2 mt-2">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <textarea name="CUSTOM_NOTICE" id="CUSTOM_NOTICE" rows="4" class="form-control ">{{ $CUSTOM_NOTICE->value }}</textarea>
                                        </div>
                                    </div>
                                </div>
