                            ...
                            <form action="{{ routeHelper('setting') }}" method="POST">
                                ...
                                <div class="card-body">
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea name="header_code" id="header_code" rows="4" class="form-control">{{ $header_code->value }} </textarea>
                                    </div>
                                    <hr>
                                    <div class="form-group col-md-12">
                                        <label for="fb_pixel" class="text-capitalize">Facebook Pixel Code</label>
                                        <textarea name="fb_pixel" id="fb_pixel" rows="4" class="form-control">{{ $fb_pixel->value }}</textarea>
                                    </div>
                                    <hr>
                                    <div class="form-group col-md-12">
                                        <label for="body_code" class="text-capitalize">Body Code</label>
                                        <textarea name="body_code" id="body_code" rows="4" class="form-control">{{ setting('body_code') ?? '' }}</textarea>
                                    </div>

                                    <hr>
                                    <div class="form-group col-md-12">
                                        <label for="global_css" class="text-capitalize">Global CSS</label>
                                        <textarea name="global_css" id="global_css" rows="4" placeholder="body{color:red;}" class="form-control">{{ setting('global_css') ?? '' }}</textarea>
                                    </div>
                                    <hr>
                                    <div class="form-group col-md-12">
                                        <label for="global_js" class="text-capitalize">Global JS</label>
                                        <textarea name="global_js" id="global_js" rows="4" placeholder="console.log('Hello Lems');" class="form-control">{{ setting('global_js') ?? '' }}</textarea>
                                    </div>
                                    <hr>
                                    <div class="form-group col-md-12">
                                    ...
                                    <div class="border border-info py-2 mt-2">
                                        <div class="form-group col-md-12">
                                            <label for="BELOW_SLIDER_HTML_CODE_STATUS" class="text-capitalize">Below Slider
                                        ...
                                        <div class="form-group col-md-12">
                                            <label for="BELOW_SLIDER_HTML_CODE" class="text-capitalize">Custom Html
                                                Code</label>
                                            <textarea name="BELOW_SLIDER_HTML_CODE" id="BELOW_SLIDER_HTML_CODE" rows="4" class="form-control">{{ setting('BELOW_SLIDER_HTML_CODE') ?? '<b>Hello www.asifulmamun.info.bd</b>' }}</textarea>
                                        </div>
                                    </div>
                                    <div class="border border-info py-2 mt-2">
                                        <div class="form-group col-md-12">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <textarea name="CUSTOM_NOTICE" id="CUSTOM_NOTICE" rows="4" class="form-control">{{ setting('CUSTOM_NOTICE') ?? 'Today is offer for 30%' }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea name="FOOTER_COL_4_HTML" id="FOOTER_COL_4_HTML" rows="4"
                                            placeholder="Payment Support: Bkash, Roacket, Nagad" class="form-control">{{ setting('FOOTER_COL_4_HTML') ?? '' }}</textarea>
                                    </div>
                                    <small class="p-4 bg-light text-primary">
                                        <a target="_blank" class="bg-warning p-2"
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input class="form-control" type="text" name="android_app" id="android_app"
