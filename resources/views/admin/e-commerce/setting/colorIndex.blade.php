                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group col-md-12">
                                        <ul>
                                            ...
                                            <li>
                                                <label for="PRIMARY_BG_TEXT_COLOR" class="text-capitalize">Primary
                                                    Background Text Color: </label>
                                                <input type="color" id="PRIMARY_BG_TEXT_COLOR_CHOOSER"
                                                    value="{{ $PRIMARY_BG_TEXT_COLOR->value }}">
                                                <input type="text" id="PRIMARY_BG_TEXT_COLOR"
                                                    name="PRIMARY_BG_TEXT_COLOR"
                                                    value="{{ $PRIMARY_BG_TEXT_COLOR->value }}">
                                            </li>
                                            <li>
                                                <label for="SECONDARY_COLOR" class="text-capitalize">Secnodary Color:
                                                </label>
                                            ...
                                            <li>
                                                <label for="OPTIONAL_BG_TEXT_COLOR" class="text-capitalize">Optional
                                                    Background Text Color: </label>
                                                <input type="color" id="OPTIONAL_BG_TEXT_COLOR_CHOOSER"
                                                    value="{{ $OPTIONAL_BG_TEXT_COLOR->value }}">
                                                <input type="text" id="OPTIONAL_BG_TEXT_COLOR"
                                                    name="OPTIONAL_BG_TEXT_COLOR"
                                                    value="{{ $OPTIONAL_BG_TEXT_COLOR->value }}">
                                            </li>
                                            <li>
                                                <label for="MAIN_MENU_BG" class="text-capitalize">Main menu background:
                                                </label>
                                            ...
                                            <li>
                                                <label for="MAIN_MENU_ul_li_color" class="text-capitalize">Main menu item
                                                    color: </label>
                                                <input type="color" id="MAIN_MENU_ul_li_color_CHOOSER"
                                                    value="{{ $MAIN_MENU_ul_li_color->value }}">
                                                <input type="text" id="MAIN_MENU_ul_li_color"
                                                    name="MAIN_MENU_ul_li_color"
                                                    value="{{ $MAIN_MENU_ul_li_color->value }}">
                                            </li>
                                        </ul>
                                    </div>
