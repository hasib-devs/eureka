                            ...
                            <form id="email_config" action="{{ routeHelper('setting') }}" method="POST">
                                ...
                                <div class="card-body">
                                    <div class="form-group col-md-12">
                                        ...
                                        <ul>
                                            <li>
                                                <label for="regVerify" class="text-capitalize">Registration verify
                                                    With</label>
                                                ...
                                                <small class="text-primary">Selected:
                                                    {{ Str::upper(setting('regVerify')) }}</small>
                                            </li>
                                            <li>
                                                ...
                                                <small class="text-primary">Selected:
                                                    {{ Str::upper(setting('recovrAC')) }}</small>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="form-group col-md-12">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <label for="MAIL_ENCRYPTION" class="text-capitalize">Encryption
                                                    Type</label>
                                                ...
                                                <small class="text-primary">Selected:
                                                    {{ Str::upper(setting('MAIL_ENCRYPTION')) }}</small>
                                            </li>
                                            <li>
                            ...
                            <form id="sms_config" action="{{ routeHelper('setting') }}" method="POST">
                                ...
                                <div class="card-body">
                                    <div class="form-group col-md-12">
                                        ...
                                        <ul>
                                            <li>
                                                <small style="color:red;">Purchase SMS and configure from: <a
                                                        href="https://bulksmsbd.com/" target="_blank"
                                                        rel="noopener noreferrer">www.bulksmsbd.com</a></small>
                                            </li>
                                            <li>
                                                <label for="sms_config_status" class="text-capitalize">SMS
                                                    Configuration</label>
