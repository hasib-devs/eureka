                            ...
                            <form id="email_config" action="{{ routeHelper('setting') }}" method="POST">
                                ...
                                <div class="card-body">
                                    <div class="col-md-12">
                                        ...
                                        <a class="btn btn-primary" href="{{ routeHelper('shop') }}">Update Main Information
                                            <i class="fas fa-caret-right"></i></a>
                                        <br><br>

                                        <ul class="form-row">
                                            <li class="col-12 col-md-6 form-group">
                                                <label for="SITE_INFO_ADDRESS" class="text-capitalize">Company full address
                                                    <span class="text-red">(*)</span></label>
                                                <input class="form-control" type="text" name="SITE_INFO_ADDRESS"
                                                    id="SITE_INFO_ADDRESS" placeholder="Company Full Address"
                                                    value="{{ $SITE_INFO_ADDRESS->value }}" required>
                                            </li>
                                            <li class="col-12 col-md-6 form-group">
                                                <label for="SITE_INFO_PHONE" class="text-capitalize">Company primary phone
                                                    <span class="text-red">(*)</span></label>
                                                <input class="form-control" type="text" name="SITE_INFO_PHONE"
                                                    id="SITE_INFO_PHONE" placeholder="Company Primary Phone"
                                                    value="{{ $SITE_INFO_PHONE->value }}" required>
                                            </li>
                                            <li class="col-12 col-md-6 form-group">
                                                <label for="SITE_INFO_SUPPORT_MAIL" class="text-capitalize">Company suupport
                                                    mail <span class="text-red">(*)</span></label>
                                                <input class="form-control" type="text" name="SITE_INFO_SUPPORT_MAIL"
                                                    id="SITE_INFO_SUPPORT_MAIL" placeholder="Company Support Email"
                                                    value="{{ $SITE_INFO_SUPPORT_MAIL->value }}" required>
                                            </li>
                                            <li class="col-12 col-md-6">
                                                <label for="copy_right_text" class="text-capitalize">Copyright Text <span
                                                        class="text-red">(*)</span></label>
                                                <input class="form-control" type="text" name="copy_right_text"
                                                    id="copy_right_text" placeholder="Company Support Email"
                                                    value="{{ setting('copy_right_text') ?? '© Lems Copyright' }}" required>
                                            </li>
                                            <li class="col-12 col-md-12">
                                                <label for="footer_description" class="text-capitalize">Footer Descripttion
                                                    <span class="text-red">(*)</span></label>
                                                <textarea name="footer_description" id="footer_description" rows="4" class="form-control" required>{{ setting('footer_description') ?? 'Footer Description, Example: This is Lems by Finvasoft' }}</textarea>
                                            </li>
                                        </ul>
                                        ...
                                        <ul class="form-row">
                                            <li class="col-12 col-md-6 form-group">
                                                <label for="email" class="text-capitalize">E-mail <span
                                                        class="text-red">(*)</span></label>
                                            ...
                                            <li class="col-12 col-md-6 form-group">
                                                ...
                                                <input class="form-control" type="text" name="messanger"
