                            ...
                            <form id="sms_config" action="{{ routeHelper('setting') }}" method="POST">
                                ...
                                <div class="card-body">
                                    <div class="form-group col-md-12">
                                        ...
                                        <ul>
                                            <li>
                                                <small style="color:red;">Get api from: <a
                                                        href="https://www.steadfast.com.bd/" target="_blank"
                                                        rel="noopener noreferrer">www.steadfast.com.bd</a></small>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <label for="STEEDFAST_API_SECRET_KEY" class="text-capitalize">API
                                                    SECRET</label>
                            ...
                            <form id="bdcourier_config" action="{{ routeHelper('setting') }}" method="POST">
                                ...
                                <div class="card-body">
                                    <div class="form-group col-md-12">
                                        ...
                                        <ul>
                                            <li>
                                                <small style="color:red;">Get api from: <a href="https://bdcourier.com/"
                                                        target="_blank" rel="noopener noreferrer">bdcourier.com</a></small>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                <label for="BDCOURIER_API_KEY" class="text-capitalize">API KEY (Bearer
                                                    Token)</label>
