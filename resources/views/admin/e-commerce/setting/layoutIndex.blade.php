                            ...
                            <form id="layoutForm" action="{{ routeHelper('setting') }}" method="POST">
                                ...
                                <div class="card-body">
                                    <ul class="form-row">
                                        ...
                                        <div
                                            class="col-10 offset-md-1 px-3 bg-light border border-info {{ $TOP_HEADER_STYLE->value == 3 ? 'visible' : 'd-none' }}">
                                            <li class="col-12 col-md-12 form-group">
                                                <label for="STYLE_3_TOP_MENU" class="text-capitalize">Style 3 top menu add:
                                                </label>
                                                <br>
                                                <textarea class="form-control w-75"
                                                    style="border:1.5px dotted rgb(9, 102, 41);padding:5px;order-radius:2%;outline:none;" name="STYLE_3_TOP_MENU"
                                            ...
                                            <li class="col-12 col-md-6 form-group">
                                                <label class="text-capitalize d-block" for="STYLE_3_TOP_MENU_BG_COLOR">Style
                                                    3 Top Menu Background Color: </label>
                                                <input class="form-control w-25 d-inline-block" type="color"
                                                    id="STYLE_3_TOP_MENU_BG_COLOR_CHOOSER"
                                                    value="{{ $STYLE_3_TOP_MENU_BG_COLOR->value }}">
                                                <input class="form-control w-50 d-inline-block" type="text"
                                            ...
                                            <li class="col-12 col-md-6 form-group">
                                                ...
                                                <input class="form-control w-50 d-inline-block" type="text"
                                                    class="border" id="STYLE_3_HEADER_SEARCH_INPUT_BAR_WIDHT"
                                        ...
                                        <li class="col-12 col-md-6 form-group">
                                            ...
                                            <input class="form-control" type="text" name="placeholder_one"
                                                id="placeholder_one"
                                        ...
                                        <li class="col-12 col-md-6 form-group">
                                            ...
                                            <input class="form-control" type="text" name="placeholder_two"
                                                id="placeholder_two"
                                                value="{{ setting('placeholder_two') ?? 'Search by Vendor' }}">
                                        </li>
                                        <li class="col-12 col-md-6 form-group">
                                            <label for="placeholder_three" class="text-capitalize">Place Holder
                                                Three</label>
                                            <input class="form-control" type="text" name="placeholder_three"
                                                id="placeholder_three"
                                                value="{{ setting('placeholder_three') ?? 'Search by category' }}">
                                        </li>
                                        <li class="col-12 col-md-6 form-group">
                                            <label for="placeholder_four" class="text-capitalize">Place Holder
                                                Four</label>
                                            <input class="form-control" type="text" name="placeholder_four"
                                                id="placeholder_four"
                                                value="{{ setting('placeholder_four') ?? 'Search by product' }}">
                                        </li>
                                        <li class="col-12 col-md-6 form-group">
                                            <label for="FLOAT_LIVE_CHAT" class="text-capitalize">Float Live Chat: </label>
                                            <select class="form-control w-50" name="FLOAT_LIVE_CHAT"
                                                id="FLOAT_LIVE_CHAT">
                                                <option class="text-white bg-success"
                                    ...
                                    <ul class="form-row">
                                        ...
                                        <li class="col-12 col-md-6 form-group">
                                            <label for="SLIDER_LAYOUT_STATUS" class="text-capitalize">Feature Products
                                                Status</label>
                                            <select class="form-control w-50" name="SLIDER_LAYOUT_STATUS"
                                        ...
                                        <li class="col-12 col-md-6 form-group">
                                            <label class="text-capitalize d-inline" for="HERO_SLIDER_1">Hero Slider 1:
                                            </label>
                                            <select class="form-control w-25 d-inline" name="HERO_SLIDER_1"
                                                id="HERO_SLIDER_1">
                                                <option class="text-white bg-success"
                                            ...
                                            <br><br>
                                            <label class="text-capitalize d-inline" for="HERO_SLIDER_2">Hero Slider 2:
                                            </label>
                                            <select class="form-control w-25 d-inline" name="HERO_SLIDER_2"
                                                id="HERO_SLIDER_2">
                                                <option class="text-white bg-success"
                                        ...
                                        <li class="col-12 col-md-6 form-group">
                                            <label for="HERO_SLIDER_1_TEXT" class="text-capitalize">Hero Slider 1
                                                Title</label>
                                            <input class="form-control w-75" type="text" name="HERO_SLIDER_1_TEXT"
                                    ...
                                    <ul class="form-row">
                                        ...
                                        <li class="col-12 col-md-6 form-group">
                                            <label for="TOP_CAT_STATUS" class="text-capitalize">Top Category
                                                Status</label>
                                            ...
                                            <input class="form-control w-75" class="border" type="text"
                                        ...
                                        <li class="col-12 col-md-6 form-group">
                                            <label for="LATEST_PRODUCT_STATUS" class="text-capitalize">Latest Products
                                                Status</label>
                                            <select class="form-control w-25" name="LATEST_PRODUCT_STATUS"
                                        ...
                                        <li class="col-12 col-md-6 form-group">
                                            <label for="FEATURE_PRODUCT_STATUS" class="text-capitalize">Feature Products
                                                Status</label>
                                            <select class="form-control w-25" name="FEATURE_PRODUCT_STATUS"
                                        ...
                                        <li class="col-12 col-md-6 form-group">
                                            <label for="CLASSIFIED_SELL_STATUS" class="text-capitalize">Classified Sell
                                                Status</label>
                                            <select class="form-control w-25" name="CLASSIFIED_SELL_STATUS"
                                        ...
                                        <li class="col-12 col-md-6 form-group">
                                            <label for="MEGA_CAT_PRODUCT_STATUS" class="text-capitalize">MEGA Cateogory
                                                Status</label>
                                            <select class="form-control w-25" name="MEGA_CAT_PRODUCT_STATUS"
                                        ...
                                        <li class="col-12 col-md-6 form-group">
                                            <label for="SUB_CAT_PRODUCT_STATUS" class="text-capitalize">Sub Cateogory
                                                Status</label>
                                            <select class="form-control w-25" name="SUB_CAT_PRODUCT_STATUS"
                                        ...
                                        <li class="col-12 col-md-6 form-group">
                                            <label for="MINI_CAT_PRODUCT_STATUS" class="text-capitalize">Mini Category
                                                Status</label>
                                            <select class="form-control w-25" name="MINI_CAT_PRODUCT_STATUS"
                                        ...
                                        <li class="col-12 col-md-6 form-group">
                                            <label for="EXTRA_CAT_PRODUCT_STATUS" class="text-capitalize">Extra Category
                                                Status</label>
                                            <select class="form-control w-25" name="EXTRA_CAT_PRODUCT_STATUS"
                                        ...
                                        <li class="col-12 col-md-6 form-group">
                                            <label for="CATEGORY_SMALL_SUMMERY" class="text-capitalize">Cateogry Small
                                                Summery Status</label>
                                            <select class="form-control w-25" name="CATEGORY_SMALL_SUMMERY"
                                        ...
                                        <li class="col-12 col-md-6 form-group">
                                            <label for="NEWS_LETTER_STATUS" class="text-capitalize">News Letter
                                                Status</label>
                                            <select class="form-control w-25" name="NEWS_LETTER_STATUS"
