...
@section('content')
    ...
    -->
    <!--<div class=" mt-3"><h3 class="title  col-md-12"><span>{{ setting('HERO_SLIDER_1_TEXT') }}</span> <a href="#"></a></h3></div>-->
    <!--
    @endif-->
...
<!--@endforeach --}}-->
    ...
    @if (!empty($homepage_category_products))
        @foreach ($homepage_category_products as $homepage_category)
            <div class="products">
                <div class="">
                    <h3 class="title"><span>{{ $homepage_category->name }}</span> <a href="{{ route('product') }}">View
                            All</a></h3>
                    <div class="row autoplay slick-slides">
    ...
    @if (setting('CLASSIFIED_SELL_STATUS') != 0 || setting('CLASSIFIED_SELL_STATUS') == '')
        @if ($unproducts->count() > 0)
            ...
            <div class="products clss">
                <div class="">
                    <h3 class="title"><span>Classified Sell</span> <a href="{{ route('clasified.all') }}">View All</a>
                    </h3>
                    <div class="row autoplay slick-slides">
            ...
            @foreach (json_decode(setting('mega_cat')) as $c)
                ...
                @if ($cat)
                    @if ($products->count() > 0)
                        <div class="products">
                            <div class="">
                                <h3 class="title"><span>{{ $cat->name }} </span><a
                                        href="{{ route('category.product', $cat->slug) }}">View All</a>
                                </h3>
                                <div class="row autoplay slick-slides">
                                    @forelse ($products as $product)
                                        <x-product-grid-view :product="$product" classes="" />
        ...
        @if (!empty(setting('sub_cat')))
            @foreach (json_decode(setting('sub_cat')) as $c)
                @php
                    ...
                    $productIds = DB::table('product_sub_category')
                ...
                @if ($cat)
                    @if ($products->count() > 0)
                        <div class="products">
                            <div class="">
                                <h3 class="title"><span>{{ $cat->name }}</span> <a
                                        href="{{ route('subCategory.product', $cat->slug) }}">View All</a>
                                </h3>
                                <div class="row autoplay slick-slides">
                                    @forelse ($products as $product)
                                        <x-product-grid-view :product="$product" classes="" />
                ...
                @if ($cat)
                    @if ($products->count() > 0)
                        <div class="products">
                            <div class="">
                                <h3 class="title"><span>{{ $cat->name }} </span> <a
                                        href="{{ route('miniCategory.product', $cat->slug) }}">View
                                        All</a></h3>
                                <div class="row autoplay slick-slides">
                                    @forelse ($products as $product)
                                        <x-product-grid-view :product="$product" classes="" />
                ...
                @if ($cat)
                    @if ($products->count() > 0)
                        <div class="products">
                            <div class="">
                                <h3 class="title"><span>{{ $cat->name }}</span> <a
                                        href="{{ route('extraCategory.product', $cat->slug) }}">View
                                        All</a></h3>
                                <div class="row autoplay slick-slides">
                                    @forelse ($products as $product)
                                        <x-product-grid-view :product="$product" classes="" />
