                            ...
                            <div class="row">
                                ...
                                <div class="form-group ">
                                    ...
                                    <input name="country" id="country"
                                        value="{{ setting('COUNTRY_SERVE') ?? 'Bangladesh' }}"
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            @auth
                                                                @if (setting('g_wallate') == 'true')
                                                                    <label for="wallate">
                                                                        <input type="radio" name="payment_method"
                                                                            class="payment_method" value="wallate"
                                                                            id="wallate">
                                                                        <img src="{{ asset('/') }}icon/wallet.png">
                                                                        Wallate
                                                                        <p>{{ auth()->user()->wallate }}</p>
                        ...
                        <div class="card">
                            ...
                            @foreach ($data as $item)
                                <div class="product mb-2.5 flex">
                                    <img class="w-12.5" src="{{ asset('uploads/product/' . $item->options->image) }}"
                                        alt="">
                                    <a class="ml-2.5"
                            ...
                            <div class="rvinfo">
                                <span>মোট</span>
                                <span><span id="sub-total">{{ $stotal }}</span><strong>
            ...
            $(document).on('click', '.payment_method', function(e) {
                ...
                if (method == 'Bkash') {
                    ...
                    appended.html('নিচে দেয়া ব্যাংকে টাকা পাঠিয়ে নিচের ফিল্ডগুলো পূরণ করুন <br> ' +
                        ...
                        '<br>Account: ' + account + '<br>Routing: ' + routing);
                ...
                document.querySelectorAll('.product').forEach(productDiv => {
                    try {
                        ...
                        if (link && priceSpan) {
                            ...
                            const itemTotal = parseFloat(priceSpan.textContent.replace(/[^0-9.]/g, '')) ||
                            0;
